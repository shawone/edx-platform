...
class LoginFailures(models.Model):
    ...
    def is_feature_enabled(cls):
        ...
        """
        return settings.FEATURES.get('ENABLE_MAX_FAILED_LOGIN_ATTEMPTS', False)
    ...
    def increment_lockout_counter(cls, user):
        ...
        max_failures_allowed = getattr(settings, 'MAX_FAILED_LOGIN_ATTEMPTS_ALLOWED', 5)
        ...
        if record.failure_count >= max_failures_allowed:
            ...
            lockout_period_secs = getattr(settings, 'MAX_FAILED_LOGIN_ATTEMPTS_LOCKOUT_PERIOD_SECS', 15 * 60)
